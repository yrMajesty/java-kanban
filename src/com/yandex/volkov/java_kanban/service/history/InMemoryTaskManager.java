...
import com.yandex.volkov.java_kanban.service.manager.Manager;
import com.yandex.volkov.java_kanban.service.manager.TaskManager;
...
public class InMemoryTaskManager implements TaskManager {
    ...
    public Epic getEpic(int epicId) {
        Epic idEpic = epicMap.get(epicId);
    ...
    public Subtask getSubtask(int subId) {
        Subtask idSubtask = subtaskMap.get(subId);
        historyManager.add(idSubtask);
