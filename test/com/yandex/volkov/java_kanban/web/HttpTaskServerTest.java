...
public class HttpTaskServerTest {
    ...
    void startServersAndInitTasks() {
        try {
            ...
            urlHttpTaskServer = HttpTaskServer.URL;
    ...
    public void getResponse_responseListWithAllTasks_tasksInManagerAreExist() {
        addTasks();
        assertEquals(gson.toJson(httpManager.getAllTasks()), sendGetRequest("tasks/task").body());
    }

    @Test
    public void getResponse_responseListWithAllSubtasks_subtasksInManagerAreExist() {
        addTasks();
        assertEquals(gson.toJson(httpManager.getAllSubtasks()), sendGetRequest("tasks/subtask").body());
    }

    @Test
    public void getResponse_responseListWithAllEpics_epicsInManagerAreExist() {
        addTasks();
        assertEquals(gson.toJson(httpManager.getAllEpics()), sendGetRequest("tasks/epic").body());
    }

    @Test
    public void getResponse_responseListWithSubtaskInEpicByIdEpic_epicWithSubtasksInManagerAreExist() {
        addTasks();
        assertEquals(gson.toJson(httpManager.getAllSubtaskInEpic(epic.getId())),
